                            ...
                            if (task.isSuccessful()) {
                                ...
                                db.collection("comerciante").document(task.getResult().getUser().
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        System.out.println("Comerciante agregado correctamente");
                                        Intent i = new Intent(getBaseContext(), Informacion.class);
                                        i.putExtra("result", true);
                                        i.putExtra("mensaje", "Comerciante agregado correctamente");
                                        startActivity(i);
                                    }
                                }).addOnFailureListener(new OnFailureListener() {
                                    @Override
                                    public void onFailure(@NonNull Exception e) {
                                        System.out.println("Error al agregar comerciante");
                                        Intent i = new Intent(getBaseContext(), Informacion.class);
                                        i.putExtra("result", false);
                                        i.putExtra("mensaje", "Error al agregar comerciante");
                                        startActivity(i);
                                    }
                                });
                            } else {
